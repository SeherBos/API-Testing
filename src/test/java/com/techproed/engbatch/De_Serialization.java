...
public class De_Serialization extends TestBaseJsonPlaceHolder {
/*
    ...
    */
    ...
    public void get01(){
        ...
        //3)Send the request
        Response response = given().spec(spec01).when().get("/{first}/{second}");
        response.prettyPrint();

        //GSON: De-serialization ==> Json Data ----> Java Object
        // as () method comes from GSON library. We added GSON as a dependency.
